import {
  ...
  describe('Redux selectors', () => {
    ...
    it('should select isAnonymous', () => {
      expect(selectIsAnonymous(mockState)).toBeFalsy();
    });
  
    it('should select isAuthLoading', () => {
      expect(selectIsAuthLoading(mockState)).toBeFalsy();
    });
    ...
    it('should select showGroupSummary', () => {
      expect(selectShowGroupSummary(mockState)).toBeFalsy();
    });
    ...
    it('should select hasStartedCounting', () => {
      expect(selectHasStartedCounting(mockState)).toBeTruthy();
    });
    ...
    it('should select isGameLoading', () => {
      expect(selectIsGameLoading(mockState)).toBeFalsy();
    });
